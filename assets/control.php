...
exit;	
	...
	echo '<META HTTP-EQUIV="Refresh" Content="0; URL=index.php?page=51&&ss=SH">';
exit;	
} 
// end plot up
...
if ($kc == "plot_akhir1" ){
	...
	$sql = $db_con->query("INSERT INTO plot_akhir VALUES (0,'$_POST[penelitian]','$_POST[mhs]','$_POST[dosen]','$_POST[dosen2]','$_POST[kategori]','$_POST[dosen3]','$_POST[dosen4]','$_POST[jurusan]','$_POST[keterangan]');");
